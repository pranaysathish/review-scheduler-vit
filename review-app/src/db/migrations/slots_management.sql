-- Create or update the slots table
...
CREATE INDEX IF NOT EXISTS idx_slots_classroom_id ON slots(classroom_id);
CREATE INDEX IF NOT EXISTS idx_slots_day ON slots(day);
CREATE INDEX IF NOT EXISTS idx_slots_review_stage ON slots(review_stage);
